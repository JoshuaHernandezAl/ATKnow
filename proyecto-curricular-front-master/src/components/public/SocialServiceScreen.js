...
import { socialServiceLoading } from '../../actions/social-service';
...
export const SocialServiceScreen = () => {
    ...
    useEffect(() => {
        dispatch(socialServiceLoading(range.from,range.limit));
    }, [dispatch,range]);
    ...
    return (
        <div className="container mt-2">
            <h3 className="text-center pt-5">Encuentra donde hacer tu servicio social</h3>
            <OptionsNavSecondary/>
            <VacanciePremium/>
